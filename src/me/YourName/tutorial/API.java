...
public class API {
	...
	public static void addPoints(Player p, int i) {
		Tutorial.points.put(p.getName(), Tutorial.points.get(p.getName()) + i);
	}
	...
	public static void addKills(Player p, int i) {
		Tutorial.kills.put(p.getName(), Tutorial.kills.get(p.getName()) + i);
	}

	public static void addDeaths(Player p, int i) {
		Tutorial.deaths.put(p.getName(), Tutorial.deaths.get(p.getName()) + i);
	}

	public static int getKills(Player p) {
		return Tutorial.kills.get(p.getName());
	}

	public static int getDeaths(Player p) {
		return Tutorial.deaths.get(p.getName());
	}

	public static int getPoints(Player p) {
		return Tutorial.points.get(p.getName());
	}
